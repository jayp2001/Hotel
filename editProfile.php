                                    ...
                                    <div class="flex col-span-8 col-start-3 imgDP justify-center">
                                        <div class="grid content-center">
                                            <div class="dp">
                                                ...
                                                <div><button class="changeImg" for="#img1" onclick="open_img()">Change</button></div>
                                                <input type="file" onchange="handleImgChange()" hidden id="img1" accept="image/*">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-12 row1-cols ml-5 mr-5">
                                    <div class="col-start-4 col-span-6 row1-col1">
                                        <div class="col-start-5 col-span-4 row1-col1">
                                            <div class="card">
                                                <form class="grid grid-rows-5 content-center">
                                                    ...
                                                    <div>
                                                        <input type="number" placeholder="Contact Number" class="input_field"/>
                                                    </div>
                                                    <div>
                                                        <input type="text" placeholder="Country" class="input_field"/>
                                                    </div>
                                                    <div class="table_footer flex justify-between">
                                                        <div><button class="saveBtn">Save Changes</button></div>
